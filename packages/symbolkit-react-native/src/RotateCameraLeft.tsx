...
function SvgRotateCameraLeft(
  ...
  return (
    ...
    >
      ...
      <Path
        d="M2.05 3v4.497c0 .278.226.503.504.503.2 0 .38-.119.466-.3A10.001 10.001 0 0112.05 2c5.186 0 9.45 3.947 9.951 9M22.001 21v-4.497a.503.503 0 00-.503-.503.52.52 0 00-.465.3A10.001 10.001 0 0112 22c-5.185 0-9.448-3.947-9.95-9"
        stroke="#000"
        strokeLinecap="round"
