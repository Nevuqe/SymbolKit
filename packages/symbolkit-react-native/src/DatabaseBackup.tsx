...
function SvgDatabaseBackup(
  ...
  return (
    ...
    >
      ...
      />
      <Path
        d="M20.995 17.667h1.671c.185 0 .334-.15.334-.334v-1.888M15.334 20.333C15.952 21.903 17.366 23 19.01 23c1.758 0 3.252-1.255 3.793-3"
        stroke="#000"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M17.005 20.333h-1.671a.334.334 0 00-.334.334v1.888"
        stroke="#000"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
