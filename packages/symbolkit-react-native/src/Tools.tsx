...
function SvgTools(
  ...
  return (
    ...
    >
      ...
      <Path
        d="M10.05 10.607l-7.07 7.07a2 2 0 102.828 2.83l7.07-7.072M17.193 13.8l3.878 3.878a2 2 0 11-2.828 2.828l-6.209-6.208M6.733 5.904L4.61 6.61 2.49 3.075l1.414-1.414L7.44 3.782l-.707 2.122zm0 0l2.83 2.83"
        stroke="#000"
        strokeLinecap="round"
