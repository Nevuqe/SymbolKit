  ...
  return (
    ...
    >
      <g clipPath="url(#battery-charging_svg__clip0_1_6558)">
        ...
        />
        <path
          d="M10.25 8.998l-1.158 2.779c-.03.074-.046.11-.04.14a.1.1 0 00.042.064c.026.017.066.017.146.017h2.52c.08 0 .12 0 .146.017a.1.1 0 01.042.064c.006.03-.01.066-.04.14l-1.158 2.779"
          stroke="#000"
          strokeLinecap="round"
