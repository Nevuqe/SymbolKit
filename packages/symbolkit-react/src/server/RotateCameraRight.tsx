...
function SvgRotateCameraRight(
  ...
  return (
    ...
    >
      ...
      <path
        d="M22.003 3v4.497A.503.503 0 0121.5 8c-.2 0-.38-.119-.466-.3A10.001 10.001 0 0012.003 2c-5.186 0-9.45 3.947-9.95 9"
        stroke="#000"
        strokeLinecap="round"
      ...
      />
      <path
        d="M12 14a2 2 0 100-4 2 2 0 000 4zM2.05 21v-4.497c0-.278.226-.503.504-.503.2 0 .38.119.466.3a10.001 10.001 0 009.03 5.7c5.186 0 9.45-3.947 9.951-9"
        stroke="#000"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
