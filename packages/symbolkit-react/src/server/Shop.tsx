...
function SvgShop(
  ...
  return (
    ...
    >
      ...
      <path d="M3 9v10a2 2 0 002 2h14a2 2 0 002-2V9" stroke="#000" />
      <path
        d="M20.485 3h-3.992l.5 5s1 1 2.5 1a3.23 3.23 0 002.139-.806.503.503 0 00.15-.465L21.076 3.5A.6.6 0 0020.485 3z"
        stroke="#000"
      />
      <path d="M16.493 3l.5 5s-1 1-2.5 1-2.5-1-2.5-1V3h4.5z" stroke="#000" />
      <path d="M11.993 3v5s-1 1-2.5 1-2.5-1-2.5-1l.5-5h4.5z" stroke="#000" />
      <path
